...
6) For unbiased estimators, the samller the variance the better.
...
From the t-table for a random variable with degrees of freedom of 20, the areas to the right of the values 0.687, 0.860, and 1.064 are .25, .20, and .15, respectively. What is the confidence level for each of the following three confidence intervals for the mean $\mu$ of a normal population distribution?
...
+ Statistical tests to compare two samples
    ...
    - assumptions for differemt t-tests
