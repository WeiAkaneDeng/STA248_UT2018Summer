...
Everything you need for the course is hosted at \url{}. Please check frequently for posting of lecture slides, practice problems and test information.
...
There is no official textbook for this course, but if you wish to have additional books/materials to look at, I suggest the following (all available through U of T library either as a physical copy or electronically).
 ...
 \begin{itemize}
        \item {\it Open Intro Statistics}, 3rd edition url{https://www.openintro.org/stat/textbook.php}
          ...
          \end{itemize}
        \item {\it A Modern Approach to Regression with R} by Simon J. Sheather.
\end{itemize}
...
+ independence 
+ moments (information from the distribution)
+ real data (bivariate normals)
