...
There are *three* quantiles ($Q1, Q2, Q3$) correspond to 25th, 50th, and 75th percentile of the data, dividing the data to **four** equal parts.
...
We want to find out what the first quantile is by solving the following:
\[
