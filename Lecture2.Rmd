...
\item Using bootstrap methods to estimate parameters
...
3) conclude from the fact that if two random variables are independent, then so are any measurable function of them. 

<br/>

You only need to be able to show 1), but you should be able to show 2) from STA247 (remember how to make a linear transformation with Jacobian). 3) is beyond the scope of this course. 
